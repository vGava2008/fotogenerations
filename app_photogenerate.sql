...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 11 2019 г., 19:17
...
(5, 'Product 4', '7603', 7, 100, 9, 2, '2019-10-23 08:59:55', '2019-12-11 12:10:42'),
...
(5, 1, 'Product Test Ru', 'Product Test Ru', 'Product Test Ru', 'Product Test Ru', 'Product Test Ru', '2019-10-23 08:59:55', '2019-12-11 12:10:42'),
(5, 2, 'Product Test EN', 'Product Test', 'Product Test', 'Product Test', 'Product Test', '2019-10-23 08:59:55', '2019-12-11 12:10:42'),
(5, 3, 'Product Test', 'Product Test', 'Product Test', 'Product Test', 'Product Test', '2019-10-23 08:59:55', '2019-12-11 12:10:42'),
(5, 4, 'Product Test', 'Product Test', 'Product Test', 'Product Test', 'Product Test', '2019-10-23 08:59:55', '2019-12-11 12:10:42'),
(5, 5, 'Product Test', 'Product Test', 'Product Test', 'Product Test', 'Product Test', '2019-10-23 08:59:55', '2019-12-11 12:10:42'),
...
(1, 5, 1, '125x324x34', 1, '2019-10-16 21:00:00', '2019-10-16 21:00:00');
...
CREATE TABLE `product_option_value` (
  ...
  `price` int(11) NOT NULL,
  `price_prefix` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `points` int(11) NOT NULL,
  `points_prefix` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `weight` int(11) NOT NULL,
  `weight_prefix` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`, `created_at`, `updated_at`) VALUES
(1, 1, 5, 1, 1, 10, 1, 155, NULL, 100, NULL, 100, NULL, '2019-12-10 22:00:00', '2019-12-10 22:00:00');
...
--
ALTER TABLE `product_option_value`
  MODIFY `product_option_value_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
