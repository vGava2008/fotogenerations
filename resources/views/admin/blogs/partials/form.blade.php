...
<td><img style="width:15%; margin-bottom: 20px;" src="{{asset('/images/blog/' . $blog->main_image)}}" alt="{{$blog->title}}"></td>
@endif 
@endif 
...
<td><img style="width:15%; margin-bottom: 20px;" src="{{asset('/images/blog/' . $blog->second_image)}}" alt="{{$blog->title_second_image}}"></td>
@endif 
@endif 
...
<td><img style="width:15%; margin-bottom: 20px;" src="{{asset('/images/blog/' . $blog->third_center_image)}}" alt="{{$blog->title_third_center_image}}"></td>
@endif 
@endif 
...
<div class="tab-content">
	...
	@endforeach
		...
		<label for="">Новость или Идея</label>
		<select class="form-control" name="status">
		  @if (isset($blog->id))
		    <option value="0" @if ($blog->status == 0) selected="" @endif>Новость</option>
		    <option value="1" @if ($blog->status == 1) selected="" @endif>Идея</option>
		  @else
